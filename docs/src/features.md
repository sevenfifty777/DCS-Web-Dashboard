...
- **Deck profiles**: Nimitz-class hulls (CVN-71/72/73/75, Stennis) and the LHA-1 Tarawa draw their full deck with parking spots and routes. The Forrestal, Kuznetsov, Essex, HMS Invincible and ARA Veinticinco de Mayo draw their top view (aircraft appear at their true deck position, no spot snapping yet). Any other hull draws a generic outline sized by class until a profile is added to `deckProfiles.ts`.
