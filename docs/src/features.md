...
- **Deck profiles**: Nimitz-class hulls (CVN-71/72/73/75, Stennis) and the LHA-1 Tarawa draw their full deck with parking spots and routes; other hulls draw a generic outline sized by class until a profile is added to `deckProfiles.ts`.
