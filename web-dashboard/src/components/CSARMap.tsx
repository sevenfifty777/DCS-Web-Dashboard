...
export default function CSARMap({ pilots }: { pilots: Pilot[] }) {
    ...
    const center = pilots.length > 0 ? [pilots[0].lat, pilots[0].lon] : [42.0, 42.0];

    return (
        <div style={{ position: 'relative', height: '400px', width: '100%', borderRadius: '1rem', overflow: 'hidden', border: '1px solid #374151' }}>
            <MapContainer center={center as any} zoom={8} style={{ height: '100%', width: '100%', backgroundColor: '#0b1118' }}>
