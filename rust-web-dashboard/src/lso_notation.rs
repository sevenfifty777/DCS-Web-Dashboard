//! Verbatim copy of `src/lso_notation.rs` from the DCS-gRPC-lso repository
//! (sevenfifty777/DCS-gRPC-lso, commit b6a2ef2). Keep in sync with the LSO client;
//! the dashboard uses it to translate `dcs_grading` into `lso_notes` at query time.
//!
